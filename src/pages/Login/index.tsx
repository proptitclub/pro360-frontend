import {
  Avatar, Box, Button, Checkbox, Container, createTheme, CssBaseline, Divider, Fab, FormControlLabel, Grid, Link, Paper, TextField,
  ThemeProvider, Typography, InputLabel, Input, FormHelperText, FormControl
} from '@mui/material';
      ...
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          >
            ...
            <Grid item xs={12} sm={8} md={5} component="form" elevation={6} style={{ backgroundColor: '#A6CFFF' }}>
              <Box
                sx={{
                  my: 8,
                  mx: 4,
              ...
              >
                <Typography component="h1" variant="h5" style={{ borderBottom: '2px solid #0057B7' }} >
                  <p><b>Sign in</b></p>
                </Typography>

                <Box component="form" noValidate sx={{ mt: 1 }} style={{ width: '100%' }}>
                  <InputLabel
                    htmlFor="my-input"
                  ...
                  <Typography style={{
                    ...
                    <p style={{ textAlign: 'center' }}>
                      ...
                      <span style={{ fontWeight: 'bold', color: '#1565C0' }}> Sign Up Now</span>
                    </p>
                  </Typography>
                </Box>
              </Box>
